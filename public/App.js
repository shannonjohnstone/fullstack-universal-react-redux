...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__MemoryRouter__ = __webpack_require__(122);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Prompt__ = __webpack_require__(123);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Redirect__ = __webpack_require__(124);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Provider__ = __webpack_require__(101);
...
exports.addToCartSuccessAction = addToCartSuccessAction;
exports.addToCartFailedAction = addToCartFailedAction;
exports.fetchCartAction = fetchCartAction;
exports.fetchCartSuccessAction = fetchCartSuccessAction;
exports.fetchCartFailedAction = fetchCartFailedAction;
exports.incrementDecrementQtyAction = incrementDecrementQtyAction;
exports.incrementDecrementQtySuccessAction = incrementDecrementQtySuccessAction;
exports.removeItemFromCartAction = removeItemFromCartAction;
...
function addToCartAction(updatedCart) {
  return {
    type: 'ADD_TO_CART',
    isSet: false,
    isFetching: true,
...
function addToCartSuccessAction(book) {
  return {
...
function addToCartFailedAction() {
  return {
...
function fetchCartSuccessAction(cart) {
  return {
...
function fetchCartFailedAction() {
  return {
...
function incrementDecrementQtyAction(_id, type, cart) {
  var actionType = 'INCREMENT_DECREMENT_QTY';
  var itemIndex = findIndexOfItemFromId(cart, _id
  //
  );var updatedItem = _extends({}, cart[itemIndex], { quantity: calculateQty(cart, type, itemIndex) });
  var updatedCart = [].concat(_toConsumableArray(cart.slice(0, itemIndex)), [updatedItem], _toConsumableArray(cart.slice(itemIndex + 1)));
...
function incrementDecrementQtySuccessAction(data) {
  return {
...
function removeItemFromCartAction(id) {
  return {
    type: 'REMOVE_ITEM',
    payload: id
  };
...
function Button(_ref) {
  ...
  return _react2.default.createElement(
    'button',
    { className: 'btn ' + btnClass, onClick: onClick, disabled: disabled },
    value
  );
}

Button.propTypes = {
  buttonType: _propTypes.string,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__HashRouter__ = __webpack_require__(111);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__Router__ = __webpack_require__(117);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__matchPath__ = __webpack_require__(120);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "matchPath", function() { return __WEBPACK_IMPORTED_MODULE_11__matchPath__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__withRouter__ = __webpack_require__(121);
...
exports.fetchBooksAction = fetchBooksAction;
exports.fetchBooksSuccessAction = fetchBooksSuccessAction;
exports.fetchBooksFailedAction = fetchBooksFailedAction;
exports.postBooksAction = postBooksAction;
exports.postBooksSuccessAction = postBooksSuccessAction;
exports.postBooksFailedAction = postBooksFailedAction;
...
function fetchBooksSuccessAction(books) {
  return {
...
function fetchBooksFailedAction() {
  return {
...
function postBooksAction(books) {
  return {
    type: 'POST_BOOK',
    isPosting: true,
    isSet: false,
...
function postBooksSuccessAction(books) {
  return {
...
function postBooksFailedAction() {
  return {
...
var _BooksForm = __webpack_require__(82);
...
var _booksActions = __webpack_require__(38);

var _BookItem = __webpack_require__(81);
...
var BooksList = function (_Component) {
  ...
  _createClass(BooksList, [{
    ...
    value: function render() {
      ...
      var books = [].concat(_toConsumableArray(this.props.books)).reverse().map(function (book) {
        return _react2.default.createElement(_BookItem2.default, { key: book._id, book: book });
      });
      return _react2.default.createElement(
        'div',
        { className: 'row' },
...
BooksList.propTypes = {
  books: (0, _propTypes.arrayOf)(_propTypes.object).isRequired
};
...
function mapDispatchToProp(dispatch) {
  return (0, _redux.bindActionCreators)({ fetchBooksAction: _booksActions.fetchBooksAction }, dispatch);
}

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProp)(BooksList);
...
var _cartActions = __webpack_require__(19);
...
var Cart = function (_Component) {
  ...
  _createClass(Cart, [{
    ...
    key: 'incrementDecrementQty',
    value: function incrementDecrementQty(e, id, type, cart) {
      e.preventDefault();
      this.props.incrementDecrementQtyAction(id, type, cart);
    }
  }, {
    key: 'removeItemFromCart',
    value: function removeItemFromCart(e, id) {
      e.preventDefault();
    ...
    value: function renderCart() {
      ...
      var cartItemList = this.props.cart.map(function (cartArr) {
        return _react2.default.createElement(
          'div',
          { className: 'row', key: cartArr._id },
          _react2.default.createElement(
            'ul',
            { className: 'list--clean col-12', key: cartArr._id },
            _react2.default.createElement(
              'li',
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'div',
                { className: 'row incrementDecrement' },
                _react2.default.createElement(
                  'button',
                  {
                    onClick: function onClick(e) {
                      return _this2.incrementDecrementQty(e, cartArr._id, 'increment', _this2.props.cart);
                    },
                ...
                _react2.default.createElement(
                  ...
                  {
                    onClick: function onClick(e) {
                      return _this2.incrementDecrementQty(e, cartArr._id, 'decrement', _this2.props.cart);
                    },
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(_Button2.default, {
                ...
                value: 'Delete',
                onClick: function onClick(e) {
                  return _this2.removeItemFromCart(e, cartArr._id);
                }
              })
            )
          )
...
Cart.propTypes = {
  incrementDecrementQtyAction: _propTypes.func.isRequired,
  removeItemFromCartAction: _propTypes.func.isRequired,
  cart: (0, _propTypes.arrayOf)((0, _propTypes.shape)({
    id: _propTypes.number,
    title: _propTypes.string,
    description: _propTypes.string,
    quantity: _propTypes.number,
    price: _propTypes.number
  })).isRequired
};
...
function mapDispatchToProps(dispatch) {
  return (0, _redux.bindActionCreators)({
    fetchCartAction: _cartActions.fetchCartAction,
    incrementDecrementQtyAction: _cartActions.incrementDecrementQtyAction,
    removeItemFromCartAction: _cartActions.removeItemFromCartAction
  }, dispatch);
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_verifyPlainObject__ = __webpack_require__(49);
...
var _BooksList = __webpack_require__(40);
...
var _NavigationNew = __webpack_require__(80);

var _NavigationNew2 = _interopRequireDefault(_NavigationNew);
...
App.propTypes = {
  totalQty: _propTypes.number.isRequired
};
...
function mapDispatchToProp(dispatch) {
  return (0, _redux.bindActionCreators)({ fetchCartAction: _cartActions.fetchCartAction }, dispatch);
}

exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProp)(App));
...
var checkIfCartMenuItem = function checkIfCartMenuItem(item, totalQty) {
  return item.url === '/cart' && totalQty > 0 && _react2.default.createElement(_Badge2.default, { className: 'badge', totalQty: totalQty });
};

function renderNav(_navConfig, index, totalQty) {
  return _navConfig[index].map(function (item) {
    return _react2.default.createElement(
      'li',
      { key: item.url, className: 'list-item navigation__list-item' },
      _react2.default.createElement(
        _reactRouterDom.Link,
        { to: item.url },
        item.page,
        checkIfCartMenuItem(item, totalQty)
      )
    );
  });
}

var NavigationNew = function (_Component) {
  _inherits(NavigationNew, _Component);

  function NavigationNew() {
    _classCallCheck(this, NavigationNew);

    return _possibleConstructorReturn(this, (NavigationNew.__proto__ || Object.getPrototypeOf(NavigationNew)).apply(this, arguments));
  }

  _createClass(NavigationNew, [{
    key: 'render',
    value: function render() {
      function destroySession() {
        (0, _axios2.default)({ method: 'post', url: 'api/services/v1/cart/endSession' });
      }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'container' },
          _react2.default.createElement('input', { type: 'checkbox', id: 'show-menu', role: 'button' }),
          _react2.default.createElement(
            'label',
            ...
            _react2.default.createElement(
              'div',
              { className: 'toggle' },
              _react2.default.createElement('span', { className: 'toggle__span' })
            )
          ),
          _react2.default.createElement(
            'ul',
            { className: 'list--clean navigation__list' },
            _react2.default.createElement(
              'li',
              { className: 'list-item navigation__list-item navigation__list-item--left' },
              _react2.default.createElement(
                'ul',
                { className: 'list--clean navigation__list' },
            ...
            _react2.default.createElement(
              'li',
              { className: 'list-item navigation__list-item navigation__list--right' },
              _react2.default.createElement(
                'ul',
                { className: 'list--clean navigation__list' },
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)(NavigationNew);
...
var BookItem = function (_Component) {
  ...
  _createClass(BookItem, [{
    key: 'addItemToCart',
    value: function addItemToCart(e, book, isInCart) {
      e.preventDefault();
      var _props = this.props,
          _addToCartAction = _props.addToCartAction,
          cart = _props.cart;

      var updatedCart = [].concat(_toConsumableArray(cart), [_extends({}, book, { quantity: 1 })]); // creating an updated cart here to make it easier for updating the cart session
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          book = _props2.book,
          _props2$book = _props2.book,
          title = _props2$book.title,
          description = _props2$book.description,
          price = _props2$book.price;

      var isInCart = this.props.cart.findIndex(function (cartItem) {
        return cartItem._id === book._id;
      }) !== -1;
      return _react2.default.createElement(
        'li',
        { className: 'list-item' },
        _react2.default.createElement(
          ...
          _react2.default.createElement(_Button2.default, {
            ...
            value: 'Add to cart',
            onClick: function onClick(e) {
              return _this2.addItemToCart(e, book, isInCart);
            }
          })
        )
      );
...
BookItem.propTypes = {
  addToCartAction: _propTypes.func.isRequired,
  book: (0, _propTypes.shape)({
    title: _propTypes.string,
    description: _propTypes.string,
    price: _propTypes.number
  }).isRequired
...
function mapDispatchToProps(dispatch) {
  return (0, _redux.bindActionCreators)({ addToCartAction: _cartActions.addToCartAction }, dispatch);
}
  ...
  _createClass(BooksForm, [{
    ...
    value: function handleSubmit(e) {
      ...
      var _refs = this.refs,
          ...
          price = _refs.price; // eslint-disable-line
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement('input', { type: 'text', name: 'title', placeholder: 'Enter title', ref: 'title', className: 'form-input' })
            ),
            _react2.default.createElement(
              'div',
              { className: 'form-group' },
              ...
              _react2.default.createElement('input', { type: 'text', name: 'description', placeholder: 'Enter description', ref: 'description', className: 'form-input' })
            ),
            _react2.default.createElement(
              'div',
              { className: 'form-group' },
              ...
              _react2.default.createElement('input', { type: 'text', name: 'price', placeholder: 'Enter price', ref: 'price', className: 'form-input' })
            ),
...
function mapDispatchToProps(dispatch) {
  return (0, _redux.bindActionCreators)({ postBooksAction: _booksActions.postBooksAction, deleteBooks: _booksActions.deleteBooks }, dispatch);
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Symbol_js__ = __webpack_require__(44);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_history_createBrowserHistory__ = __webpack_require__(86);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_history_createHashHistory__ = __webpack_require__(87);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_router__ = __webpack_require__(4);
...
var ReactPureComponent = __webpack_require__(138);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(59), __webpack_require__(151)(module)))
